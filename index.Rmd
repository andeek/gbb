...
- "Using the bootstrap for statistical inference on random graphs", Thompson, et. al. (2016)
- `snowboot` package on CRAN
...
- Boostrap *seeds* (randomly sample seeds with replacement and estimate the mean degree) or *non-seeds* (non-weighted or weighted selection)
